                    ...
                    <div class="row g-5">
                            ...
                            <div class="row g-3 ">
                                <div class="col-sm-6  pt-2">
                                    <ul class="text-light fs-5">
                                        ...
                                        <li>Call recording and voicemail</li>
                                        <li>How ever because it is hosted in the cloud</li>
                                        <li>It offers greater flexibility and scalability</li>
                        ...
                        <div class="col-lg-6 wow fadeInUp py-5 pb-0" data-aos="fade-right">
                            <div class="section-title position-relative">
                                <h3 class="mt-2 text-start text-dark">Remote IPPBX Summary :</h3>
                            </div>
                            <p class="mb-3 fs-5">In addition to its core telephony features, a remote IPPBX often integrates with other business tools, such as customer relationship management (CRM) systems, email, and instant messaging. This integration can help to improve productivity, as employees can access customer information, call history, and other relevant data from within a single, integrated platform.</p>
                            <div class="row g-3 ">
                                <div class="col-sm-6  pt-2 fs-5">
                                    <ul>
                                        <li>In summary, a remote IPPBX is a cloud-based telephone system that allows employees</li>
                                        <li>To make and receive calls from remote locations</li>
                                        <li>It offers increased flexibility</li>
                                        <li>Scalability, and integration with other business tools</li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 pt-2 fs-5">
                                    <ul>
                                        <li>Helping organizations to improve their telephony capabilities</li>
                                        <li>Manage customer interactions more effectively.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-xxl py-5">
                    <div class="container px-lg-5">
                        <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                            <h2 class="mt-2">Remote IPPBXr</h2>
                            <h6 class="position-relative d-inline text-primary ps-4">Application</h6>
                        </div>
                        <style>
                            .remote-link {
                                display: flex;
                            ...
                            .remote-link a span:hover {
                                letter-spacing: 2px;
                                background-color: #0dec75;
                            }
                        ...
                        <div class="row g-5">
                            <div class="col-lg-6">
                                <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="../assets/img/remote-ippbx.jpg" alt="remote-img-1">
                                <div class="remote-link">
                                    <a class="a" href="https://play.google.com/store/apps/details?id=com.dkkaran1996.vacremotedialer" target="_blank">
                                        <img src="https://tse2.mm.bing.net/th?id=OIP.xwnujVdDZ-3CQtWIgJER1QHaDt&amp;pid=Api&amp;P=0" alt="Download-1">
                                        <span>Download Link</span>
                                    </a>
                                </div>

                            </div>
                            <div class="col-lg-6 wow fadeInUp wow py-5" data-wow-delay="0.1s" style="border-radius: 20px;">
                                <div class="section-title position-relative mb-4 pb-2 fadeInLeft wow " data-wow-delay="0.2s">
                                    <h2 class="mt-2 text-dark">VAC Remote IPPBX</h2>
                                </div>
                                <ul class="text-dark">
                                    ...
                                    <li id="li" data-aos="fade-left" data-aos-delay="1.2s">Agents need not systems</li>
                                    <li id="li" data-aos="fade-right" data-aos-delay="1.4s">Data entry from mobile itself</li>
                                    <li id="li" data-aos="fade-left" data-aos-delay="1.6s">Caller ID hidden to agent and customers</li>
                                </ul>
                            </div>
                        </div>
                    </div>
